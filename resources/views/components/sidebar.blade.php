...
<body class="">
    <nav class="max-w-max min-w-max self-start h-full bg-white z-0 flex flex-col justify-between items-center py-4 px-8">
        <div class="flex flex-col gap-4">
            ...
            <div class="flex flex-col items-start gap-4">
                <a class="flex justify-center items-center gap-2 active:bg-green-600" href="{{ route('admin.dashboard') }}">
                    <img class="h-8" src="{{ asset('assets/images/dashboard-icon.png') }}" alt="">
                    <button class="hover:font-bold  transition-all">
                        Dashboard
                    </button>
                </a>
                <a class="flex justify-center items-center gap-2" href="{{ route('admin.patient_list') }}">
                    <img class="h-8" src="{{ asset('assets/images/patient-list-icon.png') }}" alt="">
                    <button class="hover:font-bold transition-all">
                        Patient list
                    </button>
                </a>
                <a class="flex justify-center items-center gap-2" href="{{ route('admin.contact_submission') }}">
                    <img class="h-8" src="{{ asset('assets/images/email-logo.png') }}" alt="">
                    <button class="hover:font-bold transition-all">
                        Contact submissions
                    </button>
                </a>
                <a class="flex justify-center items-center gap-2" href="{{ route('admin.appointment_submission') }}">
