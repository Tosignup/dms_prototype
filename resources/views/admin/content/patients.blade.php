    ...
    <section class=" m-4 p-4 bg-white shadow-lg rounded-md">
        <div class="flex items-center justify-between ">
            <label class="flex items-center gap-2" for="time">
                ...
                <form method="GET" action="{{ route('admin.patient_list') }}" class="flex gap-4 items-center justify-center m-4">
                    <h1>Sort by: </h1>
                    <select name="sort" class="border text-sm w-32e border-gray-400 p-2 px-4 mx-2 rounded-md" id="sort">
